...
local global_keys = awful.util.table.join(
    ...
    awful.key(
        ...
        { group = 'Awesome', description = 'Toggle app menu' }
    ),
    --#endregion
    ...
    awful.key(
        ...
        { group = 'Screens', description = 'Focus the previous/next screen' }
    ),
    ...
    awful.key(
        {modkey}, 'h',
        awful.tag.viewprev,
        { group = 'Tags', description = 'View previous/next tag' }
    ),
    ...
    awful.key(
        ...
        { group = 'Clients', description = 'Focus previous/next client' }
    ),
    ...
    awful.key(
        ...
        { group = 'Layouts', description = 'Select next layout' }
    ),
    ...
    awful.key(
        ...
        { group = 'Layouts', description = 'Decrease/increase the number of columns' }
    ),
    ...
    awful.key(
        ...
        { group = 'Apps', description = 'Open default terminal' }
    ),
    ...
    awful.key(
        ...
        { group = 'Apps', description = 'Open default file manager' }
    ),
    ...
    awful.key(
        ...
        { group = 'Apps', description = 'Open default web browser' }
    ),
    ...
    awful.key(
        ...
        { group = 'Apps', description = 'Open system monitor' }
    ),
    --#endregion
    ...
    awful.key(
        ...
        { group = 'Tools', description = 'Decrease/increase brightness' }
    ),
    ...
    awful.key(
        ...
        { group = 'Tools', description = 'Decrease/increase volume' }
    ),
    ...
    awful.key(
        ...
        { group = 'Tools', description = 'Toggle mute' }
    ),
    --#endregion
    ...
    awful.key(
		...
		{ group = 'Tools', description = 'Previous/next music'}
	),
	awful.key(
		{}, 'XF86AudioNext',
		function()
	...
	awful.key(
		...
		{ group = 'Tools', description = 'Play/pause music'}
	),
	awful.key(
		{}, 'XF86AudioPause',
		function()
    ...
    awful.key(
        ...
        { group = 'Screenshots', description = 'Full screenshot' }
    ),
    ...
    awful.key(
        ...
        { group = 'Screenshots', description = 'Area screenshot' }
    )
    --#endregion
)
...
for i, tag in pairs(tags) do
    ...
    global_keys = awful.util.table.join(
        ...
        awful.key(
            ...
            { group = 'Tags', description = 'View tag #' }
        ),
        awful.key(
            {modkey, 'Shift'},
            '#' .. i + 9,
            ...
            { group = 'Tags', description = 'Move focused client to tag #' }
        )
    )
end
...
local client_keys = awful.util.table.join(
    awful.key(
        ...
        { group = 'Clients', description = 'Toggle fullscreen' }
    ),
    ...
    awful.key(
        ...
        { group = 'Clients', description = 'Close focused client' }
    ),
    ...
    awful.key(
        ...
        { group = 'Clients', description = 'Swap with previous/next client' }
    ),
    ...
    awful.key(
        ...
        { group = 'Clients', description = 'Move client to previous/next tag' }
    ),
    ...
    awful.key(
        ...
        { group = 'Clients', description = 'Move client to previous/next screen' }
    ),
    ...
    awful.key(
        ...
        { group = 'Clients', description = 'Toggle ' }
    )
)
