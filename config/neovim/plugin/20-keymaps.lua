...
Snacks.keymap.set("n", "<C-h>", "<C-w>h", { desc = "Move to left window" })
Snacks.keymap.set("n", "<C-j>", "<C-w>j", { desc = "Move to lower window" })
Snacks.keymap.set("n", "<C-k>", "<C-w>k", { desc = "Move to upper window" })
Snacks.keymap.set("n", "<C-l>", "<C-w>l", { desc = "Move to right window" })
